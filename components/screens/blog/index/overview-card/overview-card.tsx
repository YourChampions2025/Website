...
function OverviewCard({ isHome }: OverviewCardProps) {
  ...
  return (
    <div className={styles.overviewCardContainer}>
      <div className={isHome ? styles.homeLayout : styles.overviewCardContent}>
      ...
      {isHome ? "" : <LoadMoreDynamicData>load more</LoadMoreDynamicData>}
    </div>
  );
}
