      ...
      <div className="w-full flex flex-col">
        <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-3">
          {blogs.map((blog, index) => (
            <div
              key={index}
              className="w-full h-full flex flex-col items-start [&:nth-child(3n+2)]:border-l-0 md:[&:nth-child(3n+2)]:border-l [&:nth-child(3n+2)]:border-r-0 md:[&:nth-child(3n+2)]:border-r border-b border-[#083376]"
            >
              ...
              <div className="w-full flex flex-col items-start gap-6 px-[clamp(16px,5.33vw,48px)] py-[clamp(32px,7.11vw,64px)]">
